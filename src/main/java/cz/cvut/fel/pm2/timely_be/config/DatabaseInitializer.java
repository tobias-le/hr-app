...
public class DatabaseInitializer {
    ...
    , AttendanceRecordRepository attendanceRecordRepository, ProjectRepository projectRepository, EmployeeLeaveBalanceRepository leaveBalanceRepository, LeaveRepository leaveRepository) {
        return args -> {
